...
class Dot {
    constructor(r) {
        ...
        this.vel = {x:0, y:0}  // скорость по умолчанию равна 0
        this.rad = r || random(config.dotMinRad, config.dotMaxRad);   // радиус точки ( значение будем выбирать случайным образом от 6 до максимального 20)
        this.mass = this.rad * config.massFactor;    //  масса частички (вычесляется путем приятжения одной частички другой) умножаем радиус на маленькое число
...
function isDown(){
    mouse.down = !mouse.down  //Инвертируем
    }
